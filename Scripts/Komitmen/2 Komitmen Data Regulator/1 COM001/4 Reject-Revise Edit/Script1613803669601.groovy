...
WebUI.scrollToElement(findTestObject('2 Komitmen Data Regulator/5 Revise/1 Edit'), 3)

WebUI.click(findTestObject('2 Komitmen Data Regulator/5 Revise/1 Edit'))

WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/1 Nama Komitmen'), 'Katalon Minion Edit Revise')

WebUI.delay(3)

WebUI.click(findTestObject('2 Komitmen Data Regulator/5 Revise/2 Subit'))
