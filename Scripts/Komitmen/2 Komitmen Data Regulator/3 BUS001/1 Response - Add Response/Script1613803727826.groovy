...
WebUI.scrollToElement(findTestObject('2 Komitmen Data Regulator/4 Response/2 Status Approval'), 3)

WebUI.delay(1)

WebUI.setText(findTestObject('2 Komitmen Data Regulator/4 Response/1 Status Dokumen'), 'distributed')

WebUI.setText(findTestObject('2 Komitmen Data Regulator/4 Response/2 Status Approval'), 'Approved by')

WebUI.scrollToElement(findTestObject('2 Komitmen Data Regulator/4 Response/3 Add Response'), 3)

WebUI.click(findTestObject('2 Komitmen Data Regulator/4 Response/3 Add Response'), FailureHandling.STOP_ON_FAILURE)
