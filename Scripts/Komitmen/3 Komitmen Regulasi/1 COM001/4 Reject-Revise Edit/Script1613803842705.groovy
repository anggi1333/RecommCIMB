...
WebUI.scrollToElement(findTestObject('3 Komitmen Regulasi/5 Revise/2 Edit'), 3)

WebUI.click(findTestObject('3 Komitmen Regulasi/5 Revise/2 Edit'))

WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/1 Nama Komitmen'), 'Katalon Minion Edit Revise')

WebUI.delay(1)

WebUI.click(findTestObject('3 Komitmen Regulasi/5 Revise/3 Sumbit'))
