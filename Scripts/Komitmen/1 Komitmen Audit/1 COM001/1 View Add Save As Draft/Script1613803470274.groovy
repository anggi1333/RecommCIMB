...
WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/11 Detail Audit Result'), 'Result Detail')

WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/12 Detail User Commitment'), 'User Commit Detail')
...
WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/16 Template Reminder'), 'Q1')

WebUI.delay(1)

WebUI.sendKeys(findTestObject('1 Komitmen Audit/View/Page_/16 Template Reminder'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/17 Target Date'), '19 March 2021')

WebUI.delay(1)

WebUI.sendKeys(findTestObject('1 Komitmen Audit/View/Page_/17 Target Date'), Keys.chord(Keys.ENTER))
