...
WebUI.scrollToElement(findTestObject('1 Komitmen Audit/Response/status approval'), 3)

WebUI.delay(1)

WebUI.setText(findTestObject('1 Komitmen Audit/Response/status dokumen'), 'distributed')

WebUI.setText(findTestObject('1 Komitmen Audit/Response/status approval'), 'Approved by')

WebUI.scrollToElement(findTestObject('1 Komitmen Audit/Response/Add Response'), 3)

WebUI.click(findTestObject('1 Komitmen Audit/Response/Add Response'), FailureHandling.STOP_ON_FAILURE)
