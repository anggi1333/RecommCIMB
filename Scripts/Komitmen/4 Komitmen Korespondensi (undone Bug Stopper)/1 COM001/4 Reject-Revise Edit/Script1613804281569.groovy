...
WebUI.scrollToElement(findTestObject('4 Komitmen Korespondensi (undone Bug Stopper)/3 Revise/1 Edit'), 3)

WebUI.delay(1)

WebUI.click(findTestObject('4 Komitmen Korespondensi (undone Bug Stopper)/3 Revise/1 Edit'))

WebUI.setText(findTestObject('1 Komitmen Audit/View/Page_/1 Nama Komitmen'), 'Katalon Minion Edit Revise')

WebUI.delay(3)

WebUI.click(findTestObject('4 Komitmen Korespondensi (undone Bug Stopper)/3 Revise/2 Sumbit'))
